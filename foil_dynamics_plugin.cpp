...
Foil_Dynamics_Plugin::OnUpdateSail ()
{
	...
	//cl = 8 * sin (2 * this->alpha);
	cl = 1.203 * sin(0.1037 * this->alpha - 0.0003896);
	// compute lift force at cp
	math::Vector3 lift = cl * q * this->area * liftDirection;
	...
	cd =474200 - 632200 * cos(this->alpha * -0.001617) + 0.114 * sin(this->alpha * -0.001617) +

               158100 * cos(2 * this->alpha * -0.001617) - 0.05685 * sin(2 * this->alpha * -0.001617);
	// drag at cp
	math::Vector3 drag = cd * q * this->area * dragDirection;
